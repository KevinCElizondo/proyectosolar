...
def enviar_correo(
    ...
    from_alias: Optional[str] = "Alias de correo desde el cual enviar (ej. ventas@dominio.com, opcional)",
    ...
    Args:
        ...
        from_alias: Alias de correo desde el cual enviar (opcional)
